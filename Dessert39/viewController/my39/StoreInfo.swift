...
class StoreInfo: UIViewController, CLLocationManagerDelegate {
...
//            searchBar.text = ""
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        NavigationThemeUtil.defaultTheme(self.navigationController, selfView: self, title: "매장 정보")
...
extension StoreInfo: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension StoreInfo: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        store.dummyStroe = shopNo
        performSegue(withIdentifier: "storeDetail", sender: self)
...
extension StoreInfo: UITextFieldDelegate {
