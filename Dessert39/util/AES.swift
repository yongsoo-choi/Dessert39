...
final public class AES256CBC {
    ...
    public class func customEncryptString(_ str: String, iv: String, key: String) -> String? {
    ...
    public class func encryptString(_ str: String) -> String? {
        if !str.isEmpty { // get AES initialization vector from first 16 chars
            let iv = store.AESIv
            let key = store.AESKey
    ...
    public class func decryptString(_ str: String) -> String? {
        if !str.isEmpty {
